...
const Navbar = () => {
  return (
    <header 
          className="flex justify-end mb-6 sticky top-0 z-10 py-2 px-4 bg-white/10 dark:bg-black/15 backdrop-blur-md rounded-full"
      >
        <SpeedInsights/>
        <nav className="bg-white/80 backdrop-blur-lg p-4 sticky top-0 z-50">
          <div className="container mx-auto flex justify-between items-center bg-blue/10">
